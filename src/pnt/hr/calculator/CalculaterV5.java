package pnt.hr.calculator;
import java.util.Scanner;

public class CalculaterV5 {
   ...
   //Module 4:exitprogrma 
	...
	public static boolean doYouwantToContinueTheProgram () {
		...
		if (doYouwantToContinueTheProgram.equals("yes")) {
			return true;
	...
	public static void main(String[] args) {
		...
		for( int i = 0 ; i<=3;i++) {
			...
			if (!doYouwantToContinueTheProgram()) {
				break;
